    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestInformations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TestInformations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContentOfPost = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "BookingServiceSchedules",
                columns: table => new
                {
                    ServiceId = table.Column<int>(type: "int", nullable: false),
                    BookingId = table.Column<int>(type: "int", nullable: false),
                    ScheduleLogId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingServiceSchedules", x => new { x.ScheduleLogId, x.BookingId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_BookingServiceSchedules_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookingServiceSchedules_ScheduleLogs_ScheduleLogId",
                        column: x => x.ScheduleLogId,
                        principalTable: "ScheduleLogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookingServiceSchedules_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingServiceSchedules_BookingId",
                table: "BookingServiceSchedules",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingServiceSchedules_ServiceId",
                table: "BookingServiceSchedules",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestInformations_UserId",
                table: "TestInformations",
                column: "UserId");
        }
