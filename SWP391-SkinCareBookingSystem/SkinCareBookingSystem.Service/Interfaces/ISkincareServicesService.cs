...
namespace SkinCareBookingSystem.Service.Interfaces
{
    public interface ISkincareServicesService
    {
        ...
        public Task<bool> Update(int id, string serviceName, string serviceDescription, decimal? price, int? workTime, int? categoryId, int? imageId, string benefits);
        public Task<bool> Create(string serviceName, string serviceDescription, decimal price, int workTime, int categoryId, int? imageId, string benefits);
